...
import sell.config.WechatOpenConfig;
...
public class WechartController {
   ...
   public String authorize(@RequestParam("returnUrl")String returnUrl){
        ...
        String result=wxMpService.oauth2buildAuthorizationUrl(returnUrl, WxConsts.OAUTH2_SCOPE_USER_INFO, URLEncoder.encode(url));
